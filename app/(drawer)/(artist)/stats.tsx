...
const Stats = () =>{
    return (
        <View className="flex-1 ">
            ...
            <View className='bg-whiteview rounded-2xl p-5 mb-4  '>
                <View className='flex-row justify-between items-center mb-4'>
                    <View className='flex-row items-center'>
                        <View className='bg-indigo-300 p-3 rounded-full mr-3'>
                            <Feather name="play" size={24} color="white" className='ml-1'/>
                        </View>
                        <Text className='text-indigo-800 font-bold text-lg'>Total Plays</Text>
                    </View>
                    <Text className='text-indigo-800 font-bold text-2xl'>0</Text>
                </View>
                <View className='flex-row justify-between items-end mt-2'>
                    <View>
                        <Text className='text-indigo-800 font-bold text-lg'>Recent Plays</Text>
            ...
            <View className='bg-whiteview rounded-2xl p-5 mb-6  '>
                <View className='flex-row justify-between items-center mb-4'>
                    <View className='flex-row items-center'>
                        <View className='bg-indigo-300 p-3 rounded-full mr-3'>
                            <MaterialCommunityIcons name="comment-outline" size={24} color="white" className='ml-1'/>
                        </View>
                        <Text className='text-indigo-800 font-bold text-lg'>Comments received</Text>
                    </View>
                    <Text className='text-indigo-800 font-bold text-2xl'>0</Text>
                </View>
            ...
            <View className='bg-whiteview rounded-2xl p-5 mb-10 '>
                <View className='flex-row justify-between items-start'>
                    <View className='flex-row items-center'>
                        <View className='bg-indigo-300 p-3 rounded-full mr-3'>
                            <Feather name="users" size={24} color="white" className='ml-1'/>
                        </View>
                        <Text className='text-indigo-800 font-bold text-lg'>Total Followers</Text>
                    </View>
                ...
                <View className=' flex-row justify-between mt-4 items-end'>
                    <View>
                        <Text className='text-indigo-800 font-bold text-lg'>Recent Followers</Text>
                        <Text className='text-indigo-800 text-sm '>(Last 7 days)</Text>
                    </View>
                    <View className='flex-row items-end justify-between gap-1 h-16'>
