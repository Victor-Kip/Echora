            ...
            <ScrollView className="px-6 pt-4">
                <View className="flex-row items-center justify-between mb-6 mt-2">
                    ...
                    <View className="flex-row items-center">
                        ...
                        <Feather name="link" size={24} color="black" className=" bg-white rounded-full p-2 mx-3 border border-2 border-blue-500" />
                    </View>
                </View>
                ...
                <View className=" relative  w-full h-48 bg-white items-center justify-center rounded-lg mb-6 ">
                    ...
                    <View className=" w-full absolute bottom-0 justify-around flex-row p-2 "   >
                        <View className="flex-row items-center">
                            <Feather name="heart" size={16} color="red" className="mr-2 bg-white rounded-full " />
                            <Text className="font-semibold">Like</Text>
                        </View>
                        <View className="flex-row items-center">
                            <Feather name="message-square" size={16} color="red" className="mr-2 bg-white rounded-full " />
                            <Text className="font-semibold">Comment</Text>
                        </View>
                        <View className="flex-row items-center">
                            <Feather name="share-2" size={16} color="red" className="mr-2 bg-white rounded-full " />
                ...
                <View className=" relative w-full h-48 bg-white items-start justify-center rounded-lg p-2 ">
                    ...
                    <Text className = "mt-2 text-2xl font-semibold ">Does Hydra yada yada?</Text>
